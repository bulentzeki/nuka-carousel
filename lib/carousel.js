...
var Carousel = _react2['default'].createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    ...
    if (typeof nextProps.slideIndex !== 'undefined' && nextProps.slideIndex !== this.state.currentSlide) {
  ...
  handleSwipe: function handleSwipe(e) {
    ...
    if (this.touchObject.length > this.state.slideWidth / slidesToShow / 5) {
      if (this.touchObject.direction === 1) {
        if (this.state.currentSlide >= _react2['default'].Children.count(this.props.children) - (this.props.cellAlign === 'center' ? 1 : slidesToShow) && !this.props.wrapAround) {
  ...
  nextSlide: function nextSlide() {
    ...
    if (this.props.wrapAround) {
      ...
      this.goToSlide(Math.min(this.state.currentSlide + this.state.slidesToScroll, childrenCount - (this.props.cellAlign === 'center' ? 1 : slidesToShow)));
    }
  },
